...
/* CHAR_FILL_ZERO: to fill our character array with zeros
...
*/
#define CHAR_FILL_ZERO		_IO( CHAR_MAGIC, 1 )

/* CHAR_FILL_ZERO: to fill our character array with a character
   As we can see there is not data transfer. The moment
   our driver gets this command, it executes the following
   for loop
...
*/
#define CHAR_FILL_CHAR		_IOW( CHAR_MAGIC, 2, char )

/* CHAR_SET_SIZE: to set the size of the character array */

#define CHAR_SET_SIZE		_IOW( CHAR_MAGIC, 3, uint )

/* CHAR_GET_SIZE: to get the size of the character array */
#define CHAR_GET_SIZE		_IOR( CHAR_MAGIC, 4, uint )

/* CHAR_MK_MOD_COUNT_ZERO: to make module counter as zero */
#define CHAR_MK_MOD_COUNT_ZERO	_IO( CHAR_MAGIC, 5 )

#define CHAR_MAX_CMDS		5

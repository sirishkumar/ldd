...
static int sbd_open(struct block_device *bd, struct file *);
...
static int sbd_open(struct block_device *bd, struct file  *pos)
{
	return 0;
}
...
static int __init sbd_init(void)
{
	...
	device_create(veda_class, NULL, mydev,"sbd0");
